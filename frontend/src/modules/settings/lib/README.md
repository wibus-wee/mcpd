...
- **runtime-config.ts**: 运行时配置表单结构与默认值（含 observability）
- **runtime-help.ts**: 运行时配置字段帮助文案（含 observability）
- **gateway-config.ts**: Gateway 设置表单结构与默认值
- **gateway-help.ts**: Gateway 设置字段帮助文案
